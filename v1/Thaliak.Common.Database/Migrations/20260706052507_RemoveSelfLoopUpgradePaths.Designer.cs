...
namespace Thaliak.Common.Database.Migrations
{
    ...
    [Migration("20260706052507_RemoveSelfLoopUpgradePaths")]
    partial class RemoveSelfLoopUpgradePaths
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivInstallationState", b =>
                {
                    ...
                    b.Property<int?>("LastAppliedPatchId")
                        .HasColumnType("INTEGER")
                        .HasColumnName("last_applied_patch_id");
                    ...
                    b.HasKey("RepositoryId")
                        .HasName("pk_installation_states");

                    b.HasIndex("LastAppliedPatchId")
                        .HasDatabaseName("ix_installation_states_last_applied_patch_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_installation_states_status");

                    b.ToTable("installation_states", (string)null);
                });
            ...
            modelBuilder.Entity("Thaliak.Common.Database.Models.XivInstallationState", b =>
                {
                    b.HasOne("Thaliak.Common.Database.Models.XivPatch", "LastAppliedPatch")
                        .WithMany()
                        .HasForeignKey("LastAppliedPatchId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_installation_states_patches_last_applied_patch_id");

                    b.HasOne("Thaliak.Common.Database.Models.XivRepository", "Repository")
                        .WithOne()
                        .HasForeignKey("Thaliak.Common.Database.Models.XivInstallationState", "RepositoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_installation_states_repositories_repository_id");

                    b.Navigation("LastAppliedPatch");
